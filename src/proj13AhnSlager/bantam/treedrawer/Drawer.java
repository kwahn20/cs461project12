...
package proj13AhnSlager.bantam.treedrawer;
...
public class Drawer
{
    ...
    public void draw(String sourceName, Program AST)
    {
        ...
        proj13AhnSlager.bantam.treedrawer.LayoutVisitor layout = new LayoutVisitor(fontMetrics);
        proj13AhnSlager.bantam.treedrawer.DrawingTree theDrawing = (DrawingTree) AST.accept(layout);
